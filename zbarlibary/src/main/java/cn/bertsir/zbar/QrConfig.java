...
public class QrConfig implements Serializable {
    ...
    public  int CORNER_COLOR = Color.parseColor("#000000");
    public  int LINE_COLOR = Color.parseColor("#000000");

    public  int TITLE_BACKGROUND_COLOR = Color.parseColor("#000000");
    ...
    public int getTime_out_time(){return time_out_time;
    }
