...
public class CRC16Util {
     ...
     * @return
     */
    public static boolean check(byte[] data, byte[] checkdata) {
        int crc = CRC16Util.Crc16Calc(data, data.length);
        //Logger.i( "data:"+String.format( "%04x", crc ).toUpperCase()+"checkdata"+ StringUtil.bytesToHex(checkdata));
        return String.format("%04x", crc).toUpperCase().equals(StringUtil.bytesToHex(checkdata));
    ...
    public static byte[] getCheckCode(byte[] data){
        int crc = CRC16Util.Crc16Calc(data, data.length);
        String hex=String.format("%04x", crc).toUpperCase();
